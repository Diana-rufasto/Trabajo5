#EJERCICIO01
promedio_de_un_alumno= 14.05
type_promedio_de_un_alumno=type(promedio_de_un_alumno)

promedio_de_un_alumno_es_float=isinstance(promedio_de_un_alumno,float)
promedio_de_un_alumno_es_str=isinstance(promedio_de_un_alumno,str)

print("variable promedio de un alumno es:",type_promedio_de_un_alumno)
...
#EJERCICIO03
IMC_con_calificacion_delgadez_severa=14.5684
...
IMC_con_calificacion_delgadez_severa_es_str=isinstance(IMC_con_calificacion_delgadez_severa,str)

print("variable IMC con calificacion delgadez severa:",type_IMC_con_calificacion_delgadez_severa)
print("variable es float?:",IMC_con_calificacion_delgadez_severa_es_float)
print("variable es str?:",IMC_con_calificacion_delgadez_severa_es_str)

#EJERCICIO04
dias_de_vacaciones=15
type_dias_de_vacaciones=type(dias_de_vacaciones)

dias_de_vacaciones_es_int=isinstance(dias_de_vacaciones,int)
dias_de_vacaciones_es_float=isinstance(dias_de_vacaciones,float)
...
#EJERCICIO39
ingreso_de_la_madre=1.200
type_ingreso_de_la_madre=type(ingreso_de_la_madre)

ingreso_de_la_madre_es_float=isinstance(ingreso_de_la_madre,float)
ingreso_de_la_madre_es_str=isinstance(ingreso_de_la_madre,str)
